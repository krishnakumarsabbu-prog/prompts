  ...
  (
    ...
    const baseChat = (
      <div
        ...
        style={{ backgroundColor: 'var(--devcure-bg, #0a0f1a)' }}
      ...
      >
        ...
        <div className="flex flex-row overflow-hidden w-full h-full">
          ...
          {chatStarted && (
            <div
              className="w-1 bg-[var(--vscode-border)] hover:bg-[var(--vscode-active-border)] cursor-col-resize transition-colors z-50"
          ...
          <div
            ...
            style={{
              ...
              backgroundColor: 'var(--devcure-bg, #0a0f1a)',
            }}
          >
            {!chatStarted && (
              <div id="intro" className="mt-[10vh] max-w-3xl mx-auto text-center px-4 lg:px-0 devcure-hero">
                {/* Ambient glow background */}
                <div className="devcure-ambient-glow" />

                <h1 className="text-3xl lg:text-6xl font-bold mb-4 devcure-fade-in">
                ...
                <p className="text-md lg:text-lg mb-8 text-gray-400 devcure-fade-in devcure-delay-200 max-w-xl mx-auto">
...
function ScrollToBottom() {
  ...
  return (
    !isAtBottom && (
      <>
        <div className="sticky bottom-0 left-0 right-0 bg-gradient-to-t from-[#0a0f1a] to-transparent h-20 z-10" />
        <button
